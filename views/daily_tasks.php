		...
		<div class="tab-content">
						...
						?>	
							<tr>
								...
								<td style="text-align: center;">
									<div class="btn-group">
										<a href="index.php?page=edit_daily_task&uID=<?php echo $key;?>" class='btn btn-mini tip' title="Edit"><img src="img/icons/fugue/hammer-screwdriver.png" alt=""></a>									
										<a href="index.php?page=daily_tasks&uID=<?php echo $key;?>&act=del" onclick="javascript: return confirm('Are You sure!');" class='btn btn-mini tip' title="Remove"><img src="img/icons/fugue/cross.png" alt=""></a>
									</div>
								</td>
							</tr>
						<?php	 	
			...
			<div class="tab-pane" id="condensed">
				<div class="box-content">
					<form action="index.php?page=adddaily_task" class='validate form-horizontal' method="post" name="adddaily_task" enctype="multipart/form-data">

						<div class="control-group">
							<label for="pw3" class="control-label">Question Image URL</label>
							<div class="controls">
								<input type="text" name="question_image_url" class='{required:true}'>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="incorrect_text3" class='{required:true}'>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="incorrect_text4" class='{required:true}'>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="incorrect_text5" class='{required:true}'>
							</div>
						</div>
